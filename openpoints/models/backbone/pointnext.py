...
from ..layers.gt_igu import GTIGU
...
class PointNextEncoder(nn.Module):
    ...
    # -----------------------------------------------------------
        ...
        if self.use_gt_igu:
            ...
            self.fusion_module = GTIGU(self.out_channels)
        # -----------------------------------------------------------
    ...
    def forward_seg_feat(self, p0, f0=None):
        ...
        if self.use_gt_igu:
            ...
            f_geo = self.geo_head(last_feat)
            f_tex = self.tex_head(last_feat)
            
            f_fused = self.fusion_module(f_geo, f_tex)
