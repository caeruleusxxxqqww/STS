...
export TORCH_CUDA_ARCH_LIST="8.9"   # a100: 8.0; v100: 7.0; 2080ti: 7.5; titan xp: 6.1
# module purge
...
# conda install -y pytorch=2.1.0 torchvision cudatoolkit=11.8 -c pytorch -c nvidia
